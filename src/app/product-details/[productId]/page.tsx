...
const ProductDetailsPage = () => {
  ...
  return (
    <section className="w-full bg-white">
      <div className="max-w-6xl mx-auto px-4 py-16 grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="col-span-1 flex flex-col">
          <div className="group flex items-center justify-center w-full py-10 mb-4 cursor-pointer">
            <div className="">
              <Image
                src={product.image}
                alt={product.name}
